...
const PREDEFINED_PROFILES: RoutingProfile[] = [
  ...
  },
  {
    ...
    description: 'A comfortable ride on smooth surfaces, avoiding traffic and steep climbs.',
...
export class ProfileManager {
  ...
  static addProfile(profile: Omit<RoutingProfile, 'id' | 'isCustom'>): RoutingProfile {
    const customProfiles = this.getCustomProfiles();
