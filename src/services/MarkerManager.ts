...
export class Marker {
  ...
  constructor(
    ...
    this.element.className = 'numbered-marker'
...
export class MarkerManager {
  ...
  constructor(map: any, maplibregl: any, onWaypointsChange?: (waypoints: WaypointData[]) => void) {
    this.map = map
  ...
  addMarker(lng: number, lat: number): string {
    ...
    const marker = new Marker(
      ...
      (markerId, newLng, newLat) => this.updateMarkerPosition(markerId, newLng, newLat)
    )
